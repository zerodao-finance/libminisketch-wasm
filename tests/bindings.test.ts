...
describe("bindings", () => {
  ...
  it("should test lib loading", async () => {
    ...
    let hash2: any = ethers.utils.keccak256(ethers.utils.randomBytes(8));
    let hash3: any = ethers.utils.keccak256(ethers.utils.randomBytes(8));
    ...
    console.log(sketchSerialized.toString());
